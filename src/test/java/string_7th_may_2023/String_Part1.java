...
public class String_Part1 {
	...
	public static void main(String[] args) {
		...
		// using trim() and length() together - S.trim().length(); if used together
		// because length() returns int this will also return int
		String S5 = "       Hello World Hi      ";
		System.out.println(S5.length());
		int val = S5.trim().length();
		System.out.println(val);

		// compare two string using equals, equalsIgnoreCase, compareTo(),
		// compareToIgnoreCase()
		String S6 = "Python";
		String S7 = "Java";
		...
		// indexOf() method
		// this method is used to determine whether a given text or character is
		// available in the String literal or not
		// if it is not available it will return -1
		String S23 = "We will be finishing Automation Course with Java Selenium in one month";
		System.out.println(S23.indexOf("with"));
		System.out.println(S23.indexOf('C'));
		System.out.println(S23.indexOf("in", 25));
